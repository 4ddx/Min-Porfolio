...
import chatter from '../../public/images/chatApp.png'
const chat = chatapp;
const projects = () => {
  return (
    <>
    ...
    <Product title="Chat App" githref="https://github.com/4ddx/chat-app-netlify" href="https://go-chat-2.vercel.app/" image={chatapp} desc="A simple chatroom made in Typescript and Firebase(storage)"/>
    ...
    <Product title="Chat Room" githref="https://github.com/4ddx/chatApp" href="https://chat-app-9743.vercel.app/" image={chatter} desc="A full stack chat-room made with PostgreSQL, Typescript& GraphQL."/>
